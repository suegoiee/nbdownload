...
<style>
    ...
    <nav style="margin-top:12px; float: right">
        <ul class="pagination">
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="{{route('productList.show', ['keyword'=>$keyword, 'amount' => $amount, 'orderby' => 'product_title', 'order' => $order, 'page' => $page-1])}}" rel="prev" aria-label="@lang('pagination.first')">&laquo;</a>
                </li>
                <li class="page-item">
                    <a class="page-link" href="{{ route('productList.show', ['keyword'=>$keyword, 'amount'=>$amount, 'orderby'=>'product_title', 'order'=>$order, 'page'=>1]) }}" rel="prev" aria-label="@lang('pagination.previous')">&lsaquo;</a>
                </li>
            @endif
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="{{route('productList.show', ['keyword'=>$keyword, 'amount' => $amount, 'orderby' => 'product_title', 'order' => $order, 'page' => $page+1])}}" rel="next" aria-label="@lang('pagination.next')">&rsaquo;</a>
                </li>
                <li class="page-item">
                    <a class="page-link" href="{{route('productList.show', ['keyword'=>$keyword, 'amount' => $amount, 'orderby' => 'product_title', 'order' => $order, 'page' => $result['last_page']])}}" rel="next" aria-label="@lang('pagination.last')">&raquo;</a>
                </li>
                </li>
            @endif
        </ul>
