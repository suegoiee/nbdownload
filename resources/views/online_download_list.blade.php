            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th><a href="{{route('downloadListOnline.show', ['keyword'=>$keyword, 'amount' => $amount, 'orderby' => 'download_title', 'order' => $order == 'ASC' && $orderby == 'download_title' ? 'DESC' : 'ASC', 'page' => $page])}}">Title<i class="{{$orderby == 'download_title' ? $order : ''}}"></i></a></th>
                    <th><a href="{{route('downloadListOnline.show', ['keyword'=>$keyword, 'amount' => $amount, 'orderby' => 'download_file', 'order' => $order == 'ASC' && $orderby == 'download_file' ? 'DESC' : 'ASC', 'page' => $page])}}">Title<i class="{{$orderby == 'download_file' ? $order : ''}}"></i></a></th>
                    <th><a href="{{route('downloadListOnline.show', ['keyword'=>$keyword, 'amount' => $amount, 'orderby' => 'download_file', 'order' => $order == 'ASC' && $orderby == 'download_file' ? 'DESC' : 'ASC', 'page' => $page])}}">Title<i class="{{$orderby == 'download_file' ? $order : ''}}"></i></a></th>
                    <th>Action</th>
                  </tr>
                  </tfoot>
            ...
            $.ajax({
              ...
              success:function(msg){
                ...
                msg.forEach(function(value) {
                  $("#product_pool-"+id).append('<option value='+value['product_id']+'>'+value['product_title']+'</option>');
                });
              },
              error:function(msg){
                console.log(msg);
